...
crisis_responses = {
    ...
    'depression': [
        "I'm really sorry to hear that you're feeling this way. It's important to talk about it. please talk to your parents for sometime",
        "It's okay not to be okay. Do you want to talk about what's bothering you?"
    ],
    'anxiety': [
        "Take a deep breath. You're not alone. listen to your favourite music.",
...
crisis_patterns = {
    ...
    'anxiety': [r'anxious', r'nervous', r'stressed',r'anxiety'],
